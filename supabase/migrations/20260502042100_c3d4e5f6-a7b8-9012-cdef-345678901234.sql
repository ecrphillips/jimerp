-- ============================================================
-- Fix hours_delta sign convention in create_member_booking and
-- cancel_member_booking RPCs.
--
-- Convention (per CLAUDE.md and admin UI):
--   positive hours_delta = hours CONSUMED  (BOOKING_CONFIRMED)
--   negative hours_delta = hours CREDITED BACK  (BOOKING_RETURNED)
--
-- The previous migration (20260501195324_*) had the signs reversed.
-- ============================================================
...
BEGIN
  ...
  INSERT INTO public.coroast_hour_ledger (
    ...
    v_hours, -- positive: booking consumes hours
...
BEGIN
  ...
  INSERT INTO public.coroast_hour_ledger (
    ...
    -ROUND(COALESCE(v_duration, 0), 2), -- negative: cancellation credits hours back
