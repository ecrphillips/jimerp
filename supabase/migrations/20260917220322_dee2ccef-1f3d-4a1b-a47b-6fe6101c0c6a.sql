ALTER TABLE public.shopify_product_mappings
  ADD COLUMN IF NOT EXISTS grind_rule text NOT NULL DEFAULT 'FOLLOW_SHOPIFY',
  ADD COLUMN IF NOT EXISTS grind_override_label text;

ALTER TABLE public.shopify_product_mappings
  DROP CONSTRAINT IF EXISTS shopify_product_mappings_grind_rule_check;
ALTER TABLE public.shopify_product_mappings
  ADD CONSTRAINT shopify_product_mappings_grind_rule_check
  CHECK (grind_rule IN ('FOLLOW_SHOPIFY','NEVER','ALWAYS'));
