...
import CoRoastPricing from "@/pages/internal/CoRoastPricing";
      ...
      <BrowserRouter>
        ...
        <AuthProvider>
          <Routes>
            ...
            <Route path="/accounts/quotes/new" element={
              <ProtectedRoute allowedRoles={['ADMIN', 'OPS']}>
                <InternalLayout><NewQuote /></InternalLayout>
              </ProtectedRoute>
            } />
            <Route path="/accounts/quotes/:id" element={
              <ProtectedRoute allowedRoles={['ADMIN', 'OPS']}>
                <InternalLayout><QuoteDetail /></InternalLayout>
              </ProtectedRoute>
            } />
            ...
            <Route path="/roast-groups" element={
              <ProtectedRoute allowedRoles={['ADMIN', 'OPS']}>
                <InternalLayout><RoastGroups /></InternalLayout>
              </ProtectedRoute>
            } />
            ...
            <Route path="/co-roasting/pricing" element={
              <ProtectedRoute allowedRoles={['ADMIN']}>
                <InternalLayout><CoRoastPricing /></InternalLayout>
              </ProtectedRoute>
            } />
